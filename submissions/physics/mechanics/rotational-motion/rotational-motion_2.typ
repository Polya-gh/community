...
#let subject = "physics"
#let topic = "mechanics"
#let subtopic = "Rotational Motion"
...
#let problems = (
  (
    ...
    difficulty: "easy",
    statement: [
      A wheel turns through $20 pi$ rad. How many complete revolutions does it make?
    ],
    answer: $10$,
    solution: [
      Number of revolutions $= (theta)/(2 pi) = (20 pi)/(2 pi) = 10$.
    ],
    source: "",
  ),
)
